...
In terms of risks, delegators' PUNDIX will be slashed if their validator misbehaves. For more, see [Risks](delegator-faq.md#risks) section.
...
{% hint style="info" %}
However,there is a limit to how frequent you can redelegate. For more information on [redelegation](delegator-faq.md#redelegation).
{% endhint %}
