...
The `$vePUNDIAI`(vote-escrowed `$PUNDIAI`) model is designed for [Pundi Fun AI Agent Launcher](../../pundi-fun-ai-agent-launcher-soon/) to create long-term value, sustainability, and alignment within the Pundi AI ecosystem by incentivizing holders to lock tokens, participate in governance, and support AI agent development and liquidity.&#x20;
