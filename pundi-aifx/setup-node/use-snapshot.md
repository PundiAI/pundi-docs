...
{% tab title="Mainnet" %}
```
wget -c https://fx-mainnet.s3.amazonaws.com/fxcore-pruned-snapshot-mainnet-2025-02-25.tar.gz
```
{% endtab %}

{% tab title="Testnet" %}
```
wget -c https://fx-testnet.s3.amazonaws.com/fxcore-pruned-snapshot-testnet-2025-02-25.tar.gz
```
{% endtab %}
{% endtabs %}
...
```bash
$ md5sum fxcore-pruned-snapshot-mainnet-2025-02-25.tar.gz
xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  fxcore-pruned-snapshot-mainnet-2025-02-25.tar.gz
```

> compare the md5 hash against https://fx-mainnet.s3.amazonaws.com/fxcore-pruned-snapshot-mainnet-2025-02-25.tar.gz.md5
...
```
rm -rf ~/.fxcore/data
tar -xzvf fxcore-pruned-snapshot-mainnet-2025-02-25.tar.gz -C ~/.fxcore/
```
{% endtab %}
...
```
rm -rf ~/.fxcore/data
tar -xzvf fxcore-pruned-snapshot-testnet-2025-02-25.tar.gz -C ~/.fxcore/
```
{% endtab %}
{% endtabs %}
