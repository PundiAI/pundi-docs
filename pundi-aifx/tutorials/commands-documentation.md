...
For more information regarding how to generate, sign and broadcast transactions with a multi signature account see [Multisig Transactions](commands-documentation#multisig-transactions).
...
Please refer to the [Validator Setup](https://github.com/PundiAI/pundiai-docs/blob/main/validators/validator-setup.md) section for a more complete guide on how to set up a validator.
