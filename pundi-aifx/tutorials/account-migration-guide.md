...
c. Ensure you have Pundi AIFX [command line interface](commands-documentation) installed.
...
{% content-ref url="../deploying-on-evm/metamask/add-fxcore-network.md" %}
[add-fxcore-network.md](../deploying-on-evm/metamask/add-network)
{% endcontent-ref %}
